<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
            ...
            <h1 class="mb-0">Des solutions digitales personnalisées pour votre entreprise prospère</h1>
        </div>
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                <div class="position-relative bg-primary rounded h-100 d-flex flex-column align-items-center justify-content-center text-center p-5">
                    <h3 class="text-white mb-3">Appelez nous pour un sevice</h3>
                    <p class="text-white mb-3">Faites de votre imagination une réalité.Nous sommes disponible 24h/24 pour apporter une solution à vos besoin</p>
                    <h3 class="text-white mb-0"><i class="fa fa-phone "></i>  +237 657-994-610</h3>
                    <h3 style="margin-top: 20px" class="text-white mb-0"><a href="https://wa.me/+237653531407" class="text-white" ><i class="fab fa-whatsapp"></i>  +237 653-531-407</a></h3>
                </div>
            </div>
        </div>
    </div>
