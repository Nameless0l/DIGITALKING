...
<div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
    <div class="row py-5">
        <div class="col-12 pt-lg-5 mt-lg-5 text-center">
            ...
            <a href="{{route('accueil')}}" class="h5 text-white">Acceueil</a>
            <i class="far fa-circle text-white px-2"></i>
            <a href="" class="h5 text-white">Details du blog</a>
        </div>
    </div>
</div>
@endsection
                ...
                <div class="col-lg-8">
                    ...
                    <div class="mb-5">
                        <div class="section-title section-title-sm position-relative pb-3 mb-4">
                            <h3 class="mb-0"> {{count($comments)." Comments"}}</h3>
                        </div>
                        ...
                        @empty
                            <div><h2>Aucun commentaire</h2></div>
                        @endforelse
                    ...
                    <div class="bg-light rounded p-5">
                        ...
                        <form action="{{route('add_comment',['posts_id'=>$id])}}" @method('post')>
                            @csrf
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <textarea class="form-control bg-white border-0" rows="5" name="content" @required(true) placeholder="Votre commentaire ici"></textarea>
                                </div>
                                <div class="col-12">
