    ...
    <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
        <div class="row py-5">
            <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                ...
                <a href="" class="h5 text-white">Contactez nous</a>
            </div>
        </div>
    </div>
@endsection
@section('content')
        ...
        <div class="container py-5">
            ...
            <div class="row g-5 mb-5">
                ...
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.1s">
                        <div class="bg-primary d-flex align-items-center justify-content-center rounded" style="width: 60px; height: 60px;">
                            <a hhref="https://wa.me/+237653531407"><i class="fab fa-whatsapp text-white"></i></a>
                        </div>
                        <div class="ps-4">
                            <h5 class="mb-2">Appelez pour poser n'importe quelle question</h5>
                ...
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.4s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2">envoyer nous un mail pour une commande</h5>
                            <h4 class="text-primary mb-0"><a href="#sectionToScroll">francky@gmail.com</a></h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.8s">
                        ...
                        <div class="ps-4">
                            ...
                            <h4 class="text-primary mb-0">Douala, Cameroun</h4>
                        </div>
                    </div>
                </div>
            </div>
               ...
               <div class="col-md-6">
                  <div class="map_main">
                     <div class="map-responsive">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3979.9018471908253!2d9.744801774975478!3d4.040449495933302!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zNMKwMDInMjUuNiJOIDnCsDQ0JzUwLjYiRQ!5e0!3m2!1sfr!2scm!4v1691761743511!5m2!1sfr!2scm" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                     </div>
                  </div>
               </div>
            </div>
    ...
    {{-- <div class="row g-5"   id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
